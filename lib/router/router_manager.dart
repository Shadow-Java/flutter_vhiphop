...
import 'package:flutter_eyepetizer/pages/mine/_MinePage.dart';
import 'package:flutter_eyepetizer/pages/mine/mine_page.dart';
...
//          return LoginPage();
//        }));
//    router.define(person, handler: new Handler(
//        handlerFunc: (BuildContext context, Map<String, List<String>> params) {
//          return cMinePage();
//        }));
