...
import 'package:flutter_eyepetizer/pages/home/home_override_page.dart';
import 'mine/_MinePage.dart';
...
class BottomNavigatorState extends State<BottomNavigator>{
  ...
  final tabTextStyleNormal = TextStyle(color: Colors.white);
  final tabTextStyleSelected = TextStyle(color: Colors.yellow);
  ...
  void initState() {
    ...
    tabPages ??= [HomeOverridePage(), DiscoveryPage(), HotPage(), cMinePage()];
  }
